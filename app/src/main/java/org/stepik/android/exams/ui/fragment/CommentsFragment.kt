...
/*
    companion object {
        private const val discussionIdKey = "dis_id_key"
        private const val stepIdKey = "stepId"
        private const val needInstaOpenKey = "needInstaOpenKey"

        private const val replyMenuId = 100
        private const val likeMenuId = 101
        private const val unLikeMenuId = 102
        private const val reportMenuId = 103
        private const val cancelMenuId = 104
        private const val deleteMenuId = 105
        private const val copyTextMenuId = 106
        private const val userMenuId = 107
        private const val linksStartIndexId = 300 // inclusive
