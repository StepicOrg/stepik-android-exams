...
constructor(context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = 0)
    ...
    private val baseColorDefault = ContextCompat.getColor(context, R.color.loading_view_base_color)
    private val deepColorDefault = ContextCompat.getColor(context, R.color.loading_view_deep_color)
